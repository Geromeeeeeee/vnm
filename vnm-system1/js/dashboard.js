function openDetailsModal(carId, fullName, description, dailyRate, imagesJson) {
    ...
    // Update Rent button dynamically using the passed carId
...
function handleLogout(answer) {
    ...
    if (answer === 'yes') {
        ...
        // Redirect to a public page since session requirements were removed
